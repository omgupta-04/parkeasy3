            ...
            children: [
              if (ongoing.isNotEmpty) ...[
                Padding(
                  ...
                  child: Text('Ongoing Bookings', style: TextStyle(fontWeight: FontWeight.bold)),
                ),
                ...ongoing.map((booking) => ListTile(
              ...
              if (past.isNotEmpty) ...[
                Padding(
                  padding: EdgeInsets.all(8),
                  child: Text('Past Bookings', style: TextStyle(fontWeight: FontWeight.bold)),
                ),
                ...past.map((booking) => FutureBuilder<bool>(
                  future: _parkingService.hasUserReviewed(booking.parkingSpaceId, _userId!),
